...
PolyhedralCone::PolyhedralCone(const std::string &name, float r, float g,
                             float b, float a)
...
void PolyhedralCone::setParameters(const double &radius, const double &radSpace,
...
void PolyhedralCone::getParameters(double &radius, double &radSpace, double &lonSpace) const
{
	radius = _radius;
...
void PolyhedralCone::setPlaneColor(const osg::Vec4 &color)
{
...
void PolyhedralCone::setPlaneColor(float r, float g, float b, float a)
{
...
void PolyhedralCone::setLineColor(float r, float g, float b, float a)
{
...
void PolyhedralCone::createPlane()
{
	...
	{
	  // PolyhedralCone boundary y-value at current x-location
	  ymax = sqrt(radius2 - x*x);

	  for(y = 0.0; y < ymax - epsilon; y += width)
	  {
	    // PolyhedralCone boundary x-value at current y-location
...
void PolyhedralCone::addCell(const osg::Vec2d v[], unsigned int nV)
{
